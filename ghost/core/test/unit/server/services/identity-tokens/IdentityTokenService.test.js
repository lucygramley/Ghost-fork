...
const IdentityTokenService_1 = require("../../../../../core/server/services/identity-tokens/IdentityTokenService");
...
-----END PRIVATE KEY-----`;
        ...
        const service = new IdentityTokenService_1.IdentityTokenService(privateKey, issuer, key.kid);

...
;
export const LoadingIndicator = ({ size, color, delay, style }) => {
    ...
    if (size === 'lg') {
        return (_jsx("div", { className: `flex h-64 items-center justify-center transition-opacity ${show ? 'opacity-100' : 'opacity-0'}`, style: style, children: _jsx("div", { className: styles }) }));
    }
    else {

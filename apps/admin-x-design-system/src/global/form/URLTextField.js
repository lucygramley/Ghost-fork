 ...
 */
const URLTextField = ({ baseUrl, value, transformPathWithoutSlash, nullable, onChange, ...props }) => {
    ...
    return (_jsx(TextField, { ...props, value: displayedUrl, onBlur: updateUrl, onChange: e => setDisplayedUrl(e.target.value), onFocus: handleFocus, onKeyDown: handleKeyDown }));
};

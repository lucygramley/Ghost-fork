...
describe('Page Component', () => {
    it('renders with correct structure and styling', () => {
        render(_jsx(Page, { "data-testid": "page", children: "Page Content" }));
    ...
    it('applies custom className correctly', () => {
        render(_jsx(Page, { className: "custom-page-class", "data-testid": "page", children: "Page Content" }));
        const page = screen.getByTestId('page');
    ...
    it('renders children correctly', () => {
        render(_jsxs(Page, { "data-testid": "page", children: [_jsx("h1", { children: "Page Title" }), _jsx("p", { children: "Page paragraph" }), _jsx("button", { children: "Page button" })] }));
    ...
    it('passes additional props to the div element', () => {
        render(_jsx(Page, { "data-testid": "page", id: "test-page-id", "aria-label": "Test page", children: "Page Content" }));
        const page = screen.getByTestId('page');

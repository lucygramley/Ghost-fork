...
describe('ErrorPage Component', () => {
    it('renders with correct structure and content', () => {
        render(_jsx(ErrorPage, { "data-testid": "error-page" }));
    ...
    it('applies custom className correctly', () => {
        render(_jsx(ErrorPage, { className: "custom-error-class", "data-testid": "error-page" }));
        const errorPage = screen.getByTestId('error-page');
    ...
    it('calls onBackToDashboard when back link is clicked', () => {
        ...
        render(_jsx(ErrorPage, { onBackToDashboard: handleBackToDashboard, "data-testid": "error-page" }));
        const backLink = screen.getByText(/Back to the dashboard/);
    ...
    it('passes additional props to the outer div', () => {
        render(_jsx(ErrorPage, { id: "custom-id", "aria-label": "Error message", "data-testid": "error-page" }));
        const errorPage = screen.getByTestId('error-page');

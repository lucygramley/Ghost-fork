import { SOURCE_DOMAIN_MAP, SOURCE_NORMALIZATION_MAP, normalizeSource, extractDomain, extendSourcesWithPercentages, isDomainOrSubdomain, getFaviconDomain, processSources } from '../../../src/utils/source-utils';
describe('source-utils', () => {
    describe('normalizeSource', () => {
        ...
        it('throws error for numeric sources', () => {
            expect(() => normalizeSource(123)).toThrow();
        });
    ...
    describe('getFaviconDomain', () => {
        ...
        it('returns null for invalid inputs', () => {
            expect(getFaviconDomain(null)).toEqual({
                domain: null,
                isDirectTraffic: false
            });
            ...
            expect(getFaviconDomain(123)).toEqual({
                domain: null,
                isDirectTraffic: false
            });
        });
    ...
    describe('processSources', () => {
        ...
        it('processes sources in growth mode', () => {
            const growthSources = [
                ...
                { source: null, visits: 50, free_members: 5, paid_members: 1, mrr: 25 }
            ];
            const result = processSources({
                data: growthSources,
                mode: 'growth',

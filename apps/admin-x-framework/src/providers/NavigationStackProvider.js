...
const NavigationStackContext = React.createContext({
    stack: [],
    previousPath: null,
    canGoBack: false,
    resetStack: () => { }
});
export function NavigationStackProvider({ children, maxStackSize = 100 }) {
    ...
    return (_jsx(NavigationStackContext.Provider, { value: { stack, previousPath, canGoBack, resetStack }, children: children }));
}
